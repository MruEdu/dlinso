...
TEXTS: dict[str, dict[str, str]] = {
    "ko": {
        ...
        "chat_past_summary_title": "🌿 지난 대화 요약 ({turns}턴)",
        "chat_past_summary_generating": "지난 이야기를 정리하고 있어요…",
        "chat_view_full_history": "전체 대화 보기",
        "chat_recent_turns_divider": "최근 대화",
        "input_hint": (
    ...
    "en": {
        ...
        "inquiry_back": "← Back",
        "inquiry_fab_label": "✉️ Contact us",
        "btn_start": "✅ Agree and start my story",
        "btn_continue": "✅ Continue my story",
        "gentle_record": "Your story is gently being recorded 🌿",
        "chat_past_summary_title": "🌿 Past conversation summary ({turns} turns)",
        "chat_past_summary_generating": "Summarizing your earlier story…",
        "chat_view_full_history": "View full conversation",
        "chat_recent_turns_divider": "Recent messages",
        "input_hint": (
    ...
    "mn": {
        ...
        "chat_past_summary_title": "🌿 Өмнөх ярианы тойм ({turns} эргэлт)",
        "chat_past_summary_generating": "Өмнөх түүхийг нэгтгэж байна…",
        "chat_view_full_history": "Бүтэн яриаг харах",
        "chat_recent_turns_divider": "Сүүлийн яриа",
    ...
    "ja": {
        ...
        "chat_past_summary_title": "🌿 これまでの対話の要約（{turns}ターン）",
        "chat_past_summary_generating": "これまでのお話を整理しています…",
        "chat_view_full_history": "すべての対話を見る",
        "chat_recent_turns_divider": "最近の対話",
    ...
    "zh": {
        ...
        "chat_past_summary_title": "🌿 过往对话摘要（{turns}轮）",
        "chat_past_summary_generating": "正在整理此前的对话…",
        "chat_view_full_history": "查看全部对话",
        "chat_recent_turns_divider": "最近对话",
    ...
    "vi": {
        ...
        "chat_past_summary_title": "🌿 Tóm tắt hội thoại trước ({turns} lượt)",
        "chat_past_summary_generating": "Đang tóm tắt câu chuyện trước…",
        "chat_view_full_history": "Xem toàn bộ hội thoại",
        "chat_recent_turns_divider": "Hội thoại gần đây",
