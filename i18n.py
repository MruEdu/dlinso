...
TEXTS: dict[str, dict[str, str]] = {
    "ko": {
        ...
        "input_hint": "💬 화면 **맨 아래**에 말을 적거나 📷 사진을 올려 주세요.",
        "chat_photo_label": "사진 업로드",
        "chat_photo_hint": "📷 사진의 색·구도·사물을 읽고, 마음의 정원사가 씨앗이 될 질문으로 이어갑니다.",
        "chat_alt_expander": "입력창이 안 보이면 여기를 눌러 주세요",
        "chat_alt_send": "보내기",
        "chat_ph_collect": "기억이나 사진으로 이야기를 시작해 보세요…",
        "chat_ph_giant": "지금 마음을 이어서 적어 주세요…",
        "opening": (
    ...
    "en": {
        ...
        "input_hint": "💬 Type at the **bottom** or upload a 📷 photo.",
